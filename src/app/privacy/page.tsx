  ...
  return (
    <article className="prose prose-sm max-w-2xl dark:prose-invert">
      ...
      <ul className="mt-4 list-disc space-y-2 pl-5 text-sm">
        <li><strong>Identity.</strong> You sign in with your ATProto account. We store your DID, handle, display name and avatar URL.</li>
        ...
        <li><strong>Your ATProto repository.</strong> Only if you opt in: a public booking profile, public event types, and public group sessions are written to your own account. You can remove them here or in any ATProto client.</li>
