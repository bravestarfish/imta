...
const errors: Record<string, string> = {
  missing: "Enter your username to continue.",
  resolve: "We could not find that username. Check the spelling, e.g. name.bsky.social or name.eurosky.social.",
...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string; next?: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-md py-10">
      ...
      <p className="mt-2 text-sm text-muted">Use any Atmosphere account: Bluesky, Eurosky, or your own PDS.</p>
